...
{
    g_warning("TODO syncdir:confirm_delete_tracks - needs rethink on status questions\n");
			       ...
			       GList *tracks_updated)
{
    ...
    g_warning("TODO syncdir:show_sync_summary - status\n");
		    ...
		    gboolean sync_show_summary)
{
	...
	g_warning("TODO syncdir:sync_playlist - status\n");
